...
class VolumeTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self.refresh_btn.setToolTip(
            "Re-sync every layer picker on this tab, and import any new rasters "
            "from this project's mosart/ folder (<project dir>/mosart/) into a "
            "“MOSART” group — so a layer you just added, or a MOSART Δh product "
            "that appeared on disk, shows up without reloading the plugin. Files "
            "that land in mosart/ are auto-imported too.")
        self.refresh_btn.clicked.connect(self._refresh_and_import)
